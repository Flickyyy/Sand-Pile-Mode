...
## Результат работы - картинки в формате bmp
...
4. Кодирование 1 пикселя занимает 4 бита.
...
# Results:
![alt text](preview/my50.bmp "Oval")
![alt text](preview/my800.bmp "Oval")
![alt text](preview/my4150.bmp "Oval")
![alt text](preview/my55000.bmp "Oval")


![alt text](preview/my5000.bmp "Circle")
![alt text](preview/my35000.bmp "Circle")
![alt text](preview/my335000.bmp "Circle")
![alt text](preview/my1000000.bmp "Circle")